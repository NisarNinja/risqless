		...
		<tbody>
			<tr style="vertical-align: top;" valign="top">
				<td style="word-break: break-word; vertical-align: top;" valign="top">
											...
											<div style="color:#000000;font-family:'Roboto', Tahoma, Verdana, Segoe, sans-serif;line-height:1.5;padding-top:10px;padding-right:25px;padding-bottom:10px;padding-left:25px;">
												<div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 16px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; color: #000000; mso-line-height-alt: 18px;">
													...
													<div class="img-container center fixedwidth" align="center" style="padding-right: 0px;padding-left: 0px;padding-top:20px">
						                                    <a target="_blank" rel="noopener noreferrer" href="{{$data['base_url']}}" style="outline:none" tabindex="-1"><img class="center fixedwidth" align="center" border="0" src="{{ asset('images/logo1.svg') }}" alt="Trendit" title="Trendit" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 232px; display: block;" width="232"></a>
													...
													<p style="line-height: 1.5; word-break: break-word; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 18px; margin: 0;"><br><span style="font-size: 16px;">
														<p style="font-size: 16px;">Dear {{$data['customer_name']}},</p>
												   </span>
												   <p class="card-text">We're sorry to inform you that your recent subscription payment attempt has failed.</p>
													<p class="card-text">To reactivate your subscription, please update your payment information and try again. You can do this by logging in to your account on our website and updating your payment details.</p>
													<p class="card-text">If you believe this is a mistake, please contact our support team at <a href="mailto:support@risqless.com">support@risqless.com</a> for further assistance.</p>
													<p class="card-text">Thank you for choosing our service and we hope to continue providing you with valuable content.</p>
												</p>
												</div>
											</div>
										</div>
					...
					<div style="background-color:transparent;">
						<div class="block-grid " style="min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; Margin: 0 auto; background-color: #e68500;">
							<div style="border-collapse: collapse;display: table;width: 100%;background-color:#e68500;">
								<div class="col num12" style="min-width: 320px; max-width: 600px; display: table-cell; vertical-align: top; width: 600px;">
									<div class="col_cont" style="width:100% !important;">
										<div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:15px; padding-bottom:15px; padding-right: 0px; padding-left: 0px;">
											...
											<div style="color:#ffffff;font-family:Roboto, Tahoma, Verdana, Segoe, sans-serif;line-height:1.2;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
												<div class="txtTinyMce-wrapper" style="line-height: 1.2; font-size: 12px; color: #ffffff; font-family: Roboto, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14px;">
													<p style="font-size: 14px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 17px; margin: 0;"><span style="font-size: 14px;">Risqless © 2023. All rights reserved</span></p>
												</div>
											</div>
										</div>
									</div>
